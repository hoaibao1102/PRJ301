...
public class BookDAO implements IDAO<BookDTO, String> {
    ...
    public boolean create(BookDTO entity) {
        ...
        try {
            ...
            pst.setString(1, entity.getBookID());
            pst.setString(2, entity.getBookTitle());
            pst.setString(3, entity.getBookAuthor());
            pst.setInt(4, entity.getPublishYear());
            pst.setDouble(5, entity.getPrice());
            pst.setInt(6, entity.getQuantity());
